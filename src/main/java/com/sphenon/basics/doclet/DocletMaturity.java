...
public enum DocletMaturity implements UIEquipped, TSMEquipped {

    // ----------------------------------------------------------------------------------------
    None,            //
    Scratch,         // might be ignored (will not be published automatically)
    Draft,           // not completed, but meant to be read or reviewed (will not be published automatically)
    Final,           // ready for publication (might imply automatic publishing)
    ;
    ...
    static public String convertToPersistentType   (CallContext context, DocletMaturity ad_instance) {
        return ad_instance == null ? null : ad_instance.name();
    }

    static public DocletMaturity convertFromPersistentType (CallContext context, String sm_instance) {
        return sm_instance == null ? null : java.lang.Enum.<DocletMaturity>valueOf(DocletMaturity.class, sm_instance);
    }
