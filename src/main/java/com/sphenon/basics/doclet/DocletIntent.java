...
/**
  Purpose of use
*/
public enum DocletIntent implements UIEquipped, TSMEquipped {
    ...
    Publication     //
    ;
    // (Publication, oder Edutainment?, oder Article? ...
    //  meint Artikel in Fachpublikation, Mittelding aus Marketing
    //  und Documentation)
    ...
    static public String convertToPersistentType   (CallContext context, DocletIntent ad_instance) {
        return ad_instance == null ? null : ad_instance.name();
    }

    static public DocletIntent convertFromPersistentType (CallContext context, String sm_instance) {
        return sm_instance == null ? null : java.lang.Enum.<DocletIntent>valueOf(DocletIntent.class, sm_instance);
    }
